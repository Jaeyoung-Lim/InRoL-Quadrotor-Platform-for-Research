...
*/
	...
	//double compen_w3 = 0;//-2000.0*(cur_TState.RotationEuler[2]-0.778);//0.0;+100;// for yaw		//Blue : 100 //
...
//*************************************************Translate all to Flyer's Value**********************************************************
		...
		cur_XPCommand.pitch = min(max(compen_w2 +11.7*w2,-2046),2046); // minus is positive direction   
		cur_XPCommand.roll = min(max(compen_w1 +11.4*w1,-2046),2046); // minus is positive direction   
